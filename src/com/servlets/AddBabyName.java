...
import com.bean.Baby;
import com.dao.BabyDao;
...
public class AddBabyName extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(status>0){
			...
			request.getRequestDispatcher("addbabynamefhttp://marketplace.eclipse.org/marketplace-client-intro?mpc_install=27025orm.html").include(request, response);
